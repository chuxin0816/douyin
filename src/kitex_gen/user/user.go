...
func (p *UserInfoRequest) GetAuthorId() (v int64) {
	return p.AuthorId
}
func (p *UserInfoRequest) SetUserId(val *int64) {
	p.UserId = val
}
func (p *UserInfoRequest) SetAuthorId(val int64) {
	p.AuthorId = val
}
...
func (p *UserInfoRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("User_info_request"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserInfoResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("User_info_response"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
