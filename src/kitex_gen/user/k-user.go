...
func (p *UserRegisterResponse) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
func (p *UserRegisterResponse) fastWriteField5(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *UserRegisterResponse) field5Length() int {
	l := 0
...
func (p *UserLoginResponse) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
func (p *UserLoginResponse) fastWriteField5(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "refresh_token", thrift.STRING, 5)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.RefreshToken)
...
func (p *UserLoginResponse) field5Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("refresh_token", thrift.STRING, 5)
	l += bthrift.Binary.StringLengthNocopy(p.RefreshToken)
...
func (p *UserInfoRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "User_info_request")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *UserInfoRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("User_info_request")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *UserInfoResponse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "User_info_response")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
		offset += p.fastWriteField3(buf[offset:], binaryWriter)
...
func (p *UserInfoResponse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("User_info_response")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
		l += p.field3Length()
